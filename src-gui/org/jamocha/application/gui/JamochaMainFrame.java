 ...
 */
public class JamochaMainFrame extends JFrame implements ChangeListener,
		ActionListener, BatchExecutionListener {
	 ...
	 */
	public JamochaMainFrame(final Engine engine, final BatchThread batchThread) {
		// set up the frame
	...
	private void informOfNewBatchResults() {
	...
	public void close() {
		...
		setVisible(false);
		dispose();
		batchThread.removeBatchExecutionListener(this);
		if (exitOnClose) {
