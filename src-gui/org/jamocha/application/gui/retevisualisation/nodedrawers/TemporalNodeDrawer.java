...
public class TemporalNodeDrawer extends AbstractNodeDrawer {

	public TemporalNodeDrawer(final Node owner) {
		super(owner);
	}
	...
	protected void drawNode(final int x, final int y, final int height,
		...
		canvas.setColor(new Color(28, 28, 252, alpha));
		canvas.fillPolygon(xpoints, ypoints, 4);
		canvas.setColor(new Color(107, 105, 196, alpha));
