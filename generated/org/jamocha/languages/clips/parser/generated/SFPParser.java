...
*		FactAddressType
**/
  final public SimpleNode FactAddressType() throws ParseException {
  ...
  jjtree.openNodeScope(jjtn000);Token t;
    try {
      t = jj_consume_token(SINGLEVAR);
          jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
          jjtn000.jjtSetValue(t.image); {if (true) return jjtn000;}
    } finally {
          if (jjtc000) {
            jjtree.closeNodeScope(jjtn000, true);
          }
...
// <defrules-construct> ::= (defrules (<rule-name> [<comment>] [<declaration>] <conditional-element>* => <expression>*)+)
  final public SimpleNode DefrulesConstruct() throws ParseException {
 /*@bgen(jjtree) DefrulesConstruct */
  ...
  final public SimpleNode DefruleBody() throws ParseException {
