 ...
 */
public class PathPredicateBuilder extends PathGenericBuilder<Boolean, Predicate, PathPredicateBuilder> {
    public PathPredicateBuilder(final Predicate function) {
        super(function);
    }
    ...
    public PredicateWithArguments<PathLeaf> build() {
        ...
        return new PredicateWithArgumentsComposite<PathLeaf>(this.function,
