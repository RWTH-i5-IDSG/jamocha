...
public abstract class ConditionalElement<L extends ExchangeableLeaf<L>>
    ...
    private abstract static class PositiveOrNegativeExistentialConditionalElement<L extends ExchangeableLeaf<L>>
            extends ConditionalElement<L> {
        @Getter
        final Scope scope;

        PositiveOrNegativeExistentialConditionalElement(final Scope scope,
        ...
        abstract PositiveOrNegativeExistentialConditionalElement<L> negate();
    }
    ...
    public static class ExistentialConditionalElement<L extends ExchangeableLeaf<L>>
        ...
        public String toString() {
            return "ExistentialCE " + Objects.toString(this.children);
        }

        @Override
        public NegatedExistentialConditionalElement<L> negate() {
            return new NegatedExistentialConditionalElement<>(this.scope, this.children);
        }
    }
    ...
    public static class NegatedExistentialConditionalElement<L extends ExchangeableLeaf<L>>
        ...
        public NegatedExistentialConditionalElement(final Scope scope, final AndFunctionConditionalElement<L> child) {
            super(scope, child.getChildren().size() == 1 && child.getChildren()
                    .get(0) instanceof AndFunctionConditionalElement ? (AndFunctionConditionalElement<L>) child
                    .getChildren().get(0) : child);
        }
        ...
        @Override
        public String toString() {
            return "NegatedExistentialCE " + Objects.toString(this.children);
        }

        @Override
        public ExistentialConditionalElement<L> negate() {
            return new ExistentialConditionalElement<>(this.scope, this.children);
        }
    }
    ...
    public static class TestConditionalElement<L extends ExchangeableLeaf<L>> extends ConditionalElement<L> {
        ...
        @Override
        public String toString() {
            return "TestCE (" + Objects.toString(this.predicateWithArguments) + ")";
        }
    }
    ...
    public static class OrFunctionConditionalElement<L extends ExchangeableLeaf<L>> extends ConditionalElement<L> {
        ...
        @Override
        public String toString() {
            return "OrCE " + Objects.toString(this.children);
        }
    }
    ...
    public static class AndFunctionConditionalElement<L extends ExchangeableLeaf<L>> extends ConditionalElement<L> {
        ...
        @Override
        public String toString() {
            return "AndCE " + Objects.toString(this.children);
        }
    }
    ...
    public static class NotFunctionConditionalElement<L extends ExchangeableLeaf<L>> extends ConditionalElement<L> {
        ...
        @Override
        public String toString() {
            return "NotCE " + Objects.toString(this.children);
        }
    }
    ...
    public static class TemplatePatternConditionalElement<L extends ExchangeableLeaf<L>> extends ConditionalElement<L> {
        ...
        @Override
        public String toString() {
            return "TPCE [" + Objects.toString(this.factVariable) + "]";
        }
    }
}
