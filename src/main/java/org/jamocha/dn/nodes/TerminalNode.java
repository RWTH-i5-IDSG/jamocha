...
public class TerminalNode {
    ...
    protected class TerminalEdgeImpl implements Edge {
        ...
        public Node getTargetNode() {
            throw new UnsupportedOperationException(
                    "Edges to terminal nodes don't have target 'nodes', as TerminalNode is not part of the Node "
                            + "hierarchy.");
        }
     ...
     */
    @Getter
    protected final MemoryHandlerTerminal memory;
     ...
     */
    @Getter
    protected final Defrule.Translated rule;
    ...
    public TerminalNode(final Network network, final Node parent, final Defrule.PathRule pathRule) {
        ...
        parent.acceptRegularEdgeToChild(this.edge);
        parentMemory.newNewNodeToken().enqueueInEdge(this.edge);
        parent.activateTokenQueue();
    }

    /**
     * Passes this {@link Assert} to the {@link org.jamocha.dn.ConflictSet}.
     *
     * @param plus
     *         the {@link Assert} to be passed to the {@link org.jamocha.dn.ConflictSet}
     */
    ...
    /**
     * Passes this {@link Retract} to the {@link org.jamocha.dn.ConflictSet}.
     *
     * @param minus
     *         the {@link Retract} to be passed to the {@link org.jamocha.dn.ConflictSet}
     */
