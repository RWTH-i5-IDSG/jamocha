...
/**
 * Exception thrown when a lock could not be acquired, eg if a read-lock could not be acquired in time because a
 * write-lock stalled further read-lock-requests.
 *
