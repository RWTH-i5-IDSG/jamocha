...
public class AbstractMapReducer<K, V, S extends ImmutableMinimalSet<K>, N extends ImmutableMinimalSet<Map.Entry<K, V>>>
    ...
    public boolean containsKey(final Object key) {
        return !this.equalityCheck.test(this.reductionKey, key) && this.wrapped.containsKey(key);
    }

    @Override
    public V get(final Object key) {
        if (this.equalityCheck.test(this.reductionKey, key)) return null;
