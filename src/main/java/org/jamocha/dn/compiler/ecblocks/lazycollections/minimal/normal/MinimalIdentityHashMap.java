 ...
 */
public class MinimalIdentityHashMap<K, V> extends IdentityHashMap<K, V> implements MapAsMinimalMap<K, V> {
    public MinimalIdentityHashMap() {
    }

    public MinimalIdentityHashMap(final int expectedMaxSize) {
        super(expectedMaxSize);
    }

    public MinimalIdentityHashMap(final Map<? extends K, ? extends V> m) {
        super(m);
    }
