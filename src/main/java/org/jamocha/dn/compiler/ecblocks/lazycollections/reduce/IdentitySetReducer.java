 ...
 */
public final class IdentitySetReducer<T> extends CollectionReducer<T> implements Set<T> {
    private IdentitySetReducer(final Set<T> toWrap, final T reductionElement) {
