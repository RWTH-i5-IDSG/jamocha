 ...
 */
public class MinimalHashMap<K, V> extends HashMap<K, V> implements MapAsMinimalMap<K, V> {
    public MinimalHashMap() {
    }

    public MinimalHashMap(final int expectedMaxSize) {
        super(expectedMaxSize);
    }

    public MinimalHashMap(final Map<? extends K, ? extends V> m) {
        super(m);
    }
