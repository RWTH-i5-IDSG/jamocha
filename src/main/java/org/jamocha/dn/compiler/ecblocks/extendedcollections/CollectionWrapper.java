...
public class CollectionWrapper<T> implements Collection<T> {
    ...
    public static <T> CollectionWrapper<T> with(final Collection<T> toWrap, final T additionalElement) {
        return new CollectionWrapper<>(toWrap, additionalElement);
    }

    public CollectionWrapper<T> with(final T additionalElement) {
    ...
    public boolean add(final T t) {
        throw new UnsupportedOperationException("CollectionWrapper is immutable!");
    }
