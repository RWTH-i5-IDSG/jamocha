...
public class SlotAddress implements org.jamocha.dn.memory.SlotAddress {
    /**
     * Index of the slot in the storing {@link org.jamocha.dn.memory.Fact fact}.
     *
     * -- GETTER --
     *
     * Returns the index of the slot in the storing {@link org.jamocha.dn.memory.Fact fact}.
     *
     * @return the index of the slot in the storing {@link org.jamocha.dn.memory.Fact fact}
     */
    final int index;
