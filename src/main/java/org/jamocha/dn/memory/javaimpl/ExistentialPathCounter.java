...
/**
 * Visitor for {@link org.jamocha.filter.Filter FilterElements} to determine how many of them are existential filter
 * elements and whether they are negated.
 *
...
public class ExistentialPathCounter {
    public static boolean[] getNegatedArrayFromFilter(final PathNodeFilterSet filter,
        ...
        for (final PathFilter filterElement : filterElements) {
            ...
            if (null == counterColumn) continue;
