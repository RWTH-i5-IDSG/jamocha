...
public abstract class DividedBy<R> implements Function<R> {
    ...
    static {
        ...
        FunctionDictionary
                .addGenerator(IN_CLIPS, SlotType.LONG, (final SlotType[] paramTypes) -> new DividedBy<Long>() {
                    @Override
                    public SlotType[] getParamTypes() {
                        return paramTypes;
                    }
        ...
        FunctionDictionary
                .addGenerator(IN_CLIPS, SlotType.DOUBLE, (final SlotType[] paramTypes) -> new DividedBy<Double>() {
                    @Override
                    public SlotType[] getParamTypes() {
                        return paramTypes;
                    }
