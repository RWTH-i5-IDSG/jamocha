...
public abstract class Load extends Predicate {
    public static final String IN_CLIPS = "load";
    ...
    static {
        FunctionDictionary.addFixedArgsGeneratorWithSideEffects(IN_CLIPS, SYMBOL,
    ...
    static {
        FunctionDictionary.addFixedArgsGeneratorWithSideEffects(IN_CLIPS, STRING,
                (final SideEffectFunctionToNetwork network, final SlotType[] paramTypes) -> {
                    return new Load() {
                        @Override
                        public Boolean evaluate(final Function<?>... params) {
