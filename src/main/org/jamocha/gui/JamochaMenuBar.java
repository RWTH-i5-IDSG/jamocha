...
public class JamochaMenuBar extends JMenuBar implements ActionListener {
	...
	public JamochaMenuBar(JamochaGui gui) {
		...
		helpMenuDocu = new JMenuItem("Online Documentation", IconLoader.getImageIcon("help"));
		helpMenuDocu.addActionListener(this);

		helpMenuAbout = new JMenuItem("About", IconLoader.getImageIcon("comment"));
	...
	public void actionPerformed(ActionEvent event) {
		if (event.getSource() == fileMenuQuit) {
			...
			BrowserControl.displayURL("http://www.jamocha.org/wiki/pmwiki.php?n=Documentation.Documentation", gui);
			...
			aboutDialog.add(new JScrollPane(aboutArea, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER), BorderLayout.CENTER);
