...
public class SettingsConstants {
	...
	public static final String GUI_FACTS_AUTOSORT_DIR = "gui.facts.autosort_dir";

	public static final String GUI_FACTS_AUTOSORT_BY = "gui.facts.autosort_by";

	public static final String GUI_SHELL_AUTOCOMPLETION = "gui.shell.autocompletion";

	public static final String GUI_SHELL_BACKGROUNDCOLOR = "gui.shell.backgroundcolor";

	public static final String GUI_SHELL_FONTCOLOR = "gui.shell.fontcolor";

	public static final String GUI_SHELL_FONTSIZE = "gui.shell.fontsize";
