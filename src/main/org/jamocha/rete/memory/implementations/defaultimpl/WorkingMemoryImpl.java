...
public class WorkingMemoryImpl implements WorkingMemory {
	...
	private List<WorkingMemoryElement> getList(Map< BaseNode, List<WorkingMemoryElement> > map, BaseNode node) {
	...
	private void addTo(Map< BaseNode, List<WorkingMemoryElement> > map, BaseNode node, WorkingMemoryElement element) {
		List<WorkingMemoryElement> l = getList(map, node);
		l.add(element);
	}
	
	private void removeFrom(Map< BaseNode, List<WorkingMemoryElement> > map, BaseNode node, WorkingMemoryElement element) {
		List<WorkingMemoryElement> l = getList(map, node);
		l.remove(element);
	}
