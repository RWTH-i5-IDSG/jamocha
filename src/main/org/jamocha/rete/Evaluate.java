...
public class Evaluate {
	...
	public static boolean evaluate(int operator, JamochaValue left,
		...
		case Constants.EQUAL:
			eval = evaluateEqual(left.getObjectValue(), right.getObjectValue());
			break;
		case Constants.NOTEQUAL:
			eval = evaluateNotEqual(left.getObjectValue(), right
					.getObjectValue());
			break;
		case Constants.LESS:
	...
	/**
	 * evaluate if two values are equal. If they are equal return true.
	...
	/**
	 * evaluate Boolean values against each other. If the right is a String, the
	 * method will attempt to create a new Boolean object and evaluate.
	 * 
	 * @param left
	 * @param right
	 * @return
	...
	/**
	 * evaluate if two values are not equal. If they are not equal, return true.
	 * Otherwise return false.
	 * 
	 * @param left
	 * @param right
