...
public class Atan implements Function, Serializable {
	...
	private static final class Description implements FunctionDescription {
		...
		public String getDescription() {
			return "Returns the trigonometric arc tangent of its only argument (which should be an angle as numeric expression). The return value will double.";
		}
		...
		public String getParameterDescription(int parameter) {
			return "Angle, whose trigonometric arc tangent will be returned.";
		}
