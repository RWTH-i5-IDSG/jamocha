 ...
 * 
 * Degrees converts an angle measured in degrees to an approximately equivalent
 * angle measured in radians.
 */
public class DegreesToRadians implements Function, Serializable {
	...
	public JamochaValue executeFunction(Rete engine, Parameter[] params)
		...
		if (params != null) {
			if (params.length == 1) {
				...
				if (value.getType().equals(JamochaType.DOUBLE)) {
					return JamochaValue.newDouble(Math.toRadians(value
							.getDoubleValue()));
