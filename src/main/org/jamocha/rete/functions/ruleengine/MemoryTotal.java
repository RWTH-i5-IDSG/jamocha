 ...
 * Returns NIL.
 */
public class MemoryTotal implements Function, Serializable {
	...
	public static final String NAME = "mem-total";
	...
	public JamochaValue executeFunction(Rete engine, Parameter[] params)
		...
		engine.writeMessage("Total memory " + String.valueOf(total / 1024)
				+ "Kb | " + String.valueOf(total / 1024 / 1024) + "Mb"
