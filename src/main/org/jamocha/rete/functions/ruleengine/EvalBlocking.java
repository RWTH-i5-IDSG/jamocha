...
public class EvalBlocking implements Function, Serializable {
	...
	private static final class Description implements FunctionDescription {
		...
		public String getExample() {
			return "(eval-blocking \"(printout t BlackJack)\" ?catchErr)\n"
	...
	public static final String NAME = "eval-blocking";
	...
	public JamochaValue executeFunction(Rete engine, Parameter[] params)
		...
		if (params != null && params.length >= 1) {
			...
			try {
				...
				// can't do this in finally block, because we have to do it
				// before setting the exception message in the binding.
				engine.popScope();
