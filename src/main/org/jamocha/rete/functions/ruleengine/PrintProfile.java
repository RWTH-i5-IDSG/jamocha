 ...
 * @author Peter Lin
 * 
 * print-profile will print out the current profile information.
 */
public class PrintProfile implements Function, Serializable {
	...
	public JamochaValue executeFunction(Rete engine, Parameter[] params)
		...
		engine.writeMessage("fire ET=" + ProfileStats.fireTime + " ms"
				+ Constants.LINEBREAK, "t");
		engine.writeMessage("assert ET=" + ProfileStats.assertTime + " ms"
				+ Constants.LINEBREAK, "t");
		engine.writeMessage("retract ET=" + ProfileStats.retractTime + " ms"
				+ Constants.LINEBREAK, "t");
