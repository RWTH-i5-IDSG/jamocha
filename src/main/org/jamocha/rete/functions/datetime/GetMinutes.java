 ...
 */
public class GetMinutes implements Function, Serializable {

	private static final class Description implements FunctionDescription {

		public String getDescription() {
			return "Returns the Minutes-Field from the given DateTime-Object.";
		}
		...
		public String getParameterDescription(int parameter) {
			return "DateTime to return the minutes from.";
		}
