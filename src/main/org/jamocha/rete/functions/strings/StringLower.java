 ...
 * @author Peter Lin
 * 
 * The str-lower function will return a string with lowercase
...
public class StringLower implements Function, Serializable {
	...
	private static final class Description implements
		...
		public String getDescription() {
			return "The str-lower function will return a string with lowercase alphabetic characters.";
		}
		...
		public String getParameterDescription(int parameter) {
			return "The String that will be transformed to lowercase.";
		}
