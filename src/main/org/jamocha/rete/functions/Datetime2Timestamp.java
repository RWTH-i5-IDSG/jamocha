...
public class Datetime2Timestamp implements Function, Serializable {
	...
	public static final String DATETIME2TIMESTAMP = "datetime2timestamp";

	/**
	 * 
	 */
	public Datetime2Timestamp() {
		super();
	}
	...
	public JamochaValue executeFunction(Rete engine, Parameter[] params)
		...
		if (params != null) {
			if (params.length == 1) {
				...
				return JamochaValue.newLong(p1.getTimeInMillis());
	...
	public String toPPString(Parameter[] params, int indents) {
		if (params != null && params.length == 3) {
			...
			return "(datetime2timestamp (<datetime> | <binding>) )\n" 
					+ "Function description:\n"
					+ "\t Returns the Timestamp from the given"
					+ "DateTime-Object";
		}
	}
}
