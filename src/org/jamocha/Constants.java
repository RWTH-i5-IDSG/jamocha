...
public class Constants {
	...
	public static final String VERSION = "0.9 Beta 9";

	public static final String VERSION_NAME = "Schweinegulasch";
	...
	public static final String TEMPORAL_STRATEGY = "TIME_FACT"; // can be "TRIGGER_FACT", "SEPARATE_RETE" or "TIME_FACT"
