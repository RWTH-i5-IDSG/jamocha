...
public class SimpleBetaFilterNodeDrawer extends AbstractNodeDrawer {

	public SimpleBetaFilterNodeDrawer(final Node owner) {
		super(owner);
	}
	...
	protected void drawNode(final int x, final int y, final int height,
		...
		final int[] xpoints = { x, x + width, (int) (x + width * 0.8),
				x + (int) (width * 0.2) };
		final int[] ypoints = { y + height, y + height, y, y };
