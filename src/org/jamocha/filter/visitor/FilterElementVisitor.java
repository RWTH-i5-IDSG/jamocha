...
import org.jamocha.filter.AddressFilter.NonExistentialAddressFilterElement;
...
public interface FilterElementVisitor extends Visitor {
	...
	public void visit(final NonExistentialAddressFilterElement fe);

	public void visit(final PathFilterElement fe);

	public void visit(final ExistentialPathFilterElement fe);

	public void visit(final NonExistentialPathFilterElement fe);
}
