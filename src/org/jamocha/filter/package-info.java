 ...
 * 
 * A Filter contains so-called {@link org.jamocha.filter.NodeFilterSet.Filter filter elements}
 ...
 * In a {@link org.jamocha.filter.NodeFilterSet.Filter filter element}, these predicates are stored
 ...
 * {@link org.jamocha.filter.PathNodeFilterSetToAddressNodeFilterSetTranslator#translate(PathFilter, org.jamocha.dn.memory.CounterColumnMatcher)}
 ...
 * {@link org.jamocha.filter.NodeFilterSet.PathFilter PathFilterElements} are translated into
 * {@link org.jamocha.filter.AddressNodeFilterSet.AddressFilter AddressFilterElements} storing the
 * addresses formerly stored in the {@link org.jamocha.filter.Path paths}.
 * 
 * @author Fabian Ohler <fabian.ohler1@rwth-aachen.de>
 * @see org.jamocha.filter.NodeFilterSet
 * @see org.jamocha.filter.NodeFilterSet.Filter
