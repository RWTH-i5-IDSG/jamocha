...
public class DeftemplateConstructBean extends FunctionCallBean {
	SymbolBean name;
	final List<SlotDefinitionBean> slots = new ArrayList<>();

	public void addSlot(final SlotDefinitionBean slot) {
		slots.add(slot);
	}
