...
@Data
public class ConstraintAttributeBean extends TemplateAttributeBean {
	final EnumSet<Type> allowedTypes = EnumSet.noneOf(Type.class);

	public void addAllowedType(final Type allowedType) {
