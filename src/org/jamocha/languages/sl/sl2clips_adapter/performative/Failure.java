...
/**
 * Translates SL code of a failure to CLIPS code. A failure consists of an
 * action that has failed and a proposition giving the reason for the failure.
 * 
 * @author Daniel Grams, Georg Jennessen, Alexander Wilden
 * 
 */
class Failure extends SLPerformativeTranslator {

	/**
	 * Translates SL code of a failure to CLIPS code. A failure consists of an
	 * action that has failed and a proposition giving the reason for the
	 * failure.
	 * 
	 * @param slContent
