...
/**
 * Translates SL code of an agree to CLIPS code. An agree consists of an action
 * the sender intends to perform sometime in the future and a proposition giving
 * the conditions of the agreement.
 * <p>
 * The translation is done by just asserting an "agent-agree-result" fact that
 * has to be handled according to the underlying ontology.
 * 
 * @author Alexander Wilden
 * 
 */
class Agree extends SLPerformativeTranslator {

	/**
	 * Translates SL code of an agree to CLIPS code. An agree consists of an
	 * action the sender intends to perform sometime in the future and a
	 * proposition giving the conditions of the agreement.
	 * <p>
	 * The translation is done by just asserting an "agent-agree-result" fact
	 * that has to be handled according to the underlying ontology.
	 * 
	 * @param slContent
