...
public abstract class AbstractColumn<O extends ECOccurrenceNode, B extends BindingNode> implements Column<O, B> {
	final Set<AssignmentGraph.Edge<O, B>> edges;

	public AbstractColumn(final Column<O, B> other) {
		this.edges = newIdentityHashSet(other.getEdges());
	}
}
