...
public interface StatisticsProvider {
	 ...
	 * 
	 * For existential components, the joinOrder contains exactly one component in the left part of
	 * the pair and exactly one filter in the right part of the pair.
	 * 
	...
	/**
	 * In case the input component is meant to be existential, the joinOrder is expected to not
	 * contain the other existential components and their filters.
	 * 
	 * For existential components, the joinOrder contains exactly one component in the left part of
	 * the pair and exactly one filter in the right part of the pair.
	 * 
