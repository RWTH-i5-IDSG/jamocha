...
public class ProfileStats {
	...
	/**
	 * method should be called when Rete.fire is called or simply turn on
	 * profiling in Rete.
	 */
	...
	/**
	 * endFire will automatically calculate the elapsed time and add it to the
	 * total fire time. if the start fire timestamp is zero, the elapsed time
	 ...
	 * @param time
	 */
	public static void addFireET(final long time) {
		fireTime += time;
	}

	/**
	 * method should be called before assert is called or turn profiling in
	 * Rete.
	 */
	...
	/**
	 * method will automatically calculate the elapsed time and add it to the
	 * total assert time. if the start assert timestamp is zero, elpased time
	 * will not be calculated and added.
	 */
	 ...
	 * @param time
	 */
	public static void addAssertET(final long time) {
		assertTime += time;
	}

	/**
	 * the method should be called before retract is called or turn of profiling
	 * in the Rete class.
	 */
	...
	/**
	 * method will calculate the elapsed time and add it to the total retract
	 * time. if the start retract timestamp is zero the elapsed time will not be
	 * calculated.
	 */
	 ...
	 * @param time
	 */
	public static void addRetractET(final long time) {
		retractTime += time;
	}
	...
	public static void addAddActivationET(final long time) {
		addActivation += time;
	}
	...
	public static void addRemoveActivationET(final long time) {
		rmActivation += time;
	}
