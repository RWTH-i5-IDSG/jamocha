 ...
 * 
 * Creates a list of a given string. Optionally a separator where to split the
 * string can be provided. Default separator is the space character.
 */
