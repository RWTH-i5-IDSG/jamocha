 ...
 * returns the extended list. If a list of items is inserted each item of it is
 * inserted separately, so there are no nested lists.
 * <p>
...
public class InsertList$ extends AbstractFunction {
	...
	private static final class Description implements FunctionDescription {
		...
		public Object getExpectedResult() {
			return "[cheese, milk, eggs, butter, bread, sausages]";
		}
	}
	...
	public static final String NAME = "insert-list$";
