 ...
 * facts and rules.
 */
public class Watch extends AbstractFunction {
	...
	private static final class Description implements FunctionDescription {
		...
		public String getParameterDescription(int parameter) {
			return "What to watch. One or several of: all, facts, activations, rules or none."
					+ "Value is not stored. If you want to do so use (set) function or GUI settings instead.";
		}
