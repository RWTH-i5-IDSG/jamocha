 ...
 * @author Peter Lin
 * 
 * ConversioUtils has a methods for autoboxing primitive types with the Object
 * equivalent.
 */
public class ConversionUtils {
	...
	static {
		...
		STROPR_MAP.put(Constants.GREATEREQUAL_STRING,
				Constants.GREATEREQUAL_SYMBOL);
	...
	/**
	 * Method will merge the two arrays by add the facts from the right to the
	 * end
	 * 
	 * @param left
	 * @param right
	...
	/**
	 * Convienance method for converting the int type code to the string form
	 * 
	 * @param intType
	 * @return
	 */
	...
	/**
	 * If the operate is equal, not equal, greater, less than, greater or equal,
	 * less than or equal.
	 * 
	 * @param strSymbol
	 * @return
	...
	public static void main(String[] args) {
		/**
		 * String[] left = {"one","two","three"}; String[] right =
		 * {"four","five"}; String[] m = (String[])mergeFacts(left,right); for
		 * (int idx=0; idx < m.length; idx++){ System.out.println(m[idx]); }
		 */
	}
}
