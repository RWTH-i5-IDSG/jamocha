...
public class EqualsTest {
	...
	Double i = 5.;
		return Arrays.asList( new Object[][] {
				...
				{192853692L, 192853692L, 17.3, 17.3, false, 5. != i, "OMG", "OMG" },
				{9223372036854775807L, 9223372036854775807L, Double.MAX_VALUE, new Double(Double.MAX_VALUE), true, 5. == i, "foobar", "foobar" }
		});
	}
